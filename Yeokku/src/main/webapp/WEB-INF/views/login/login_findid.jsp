...
<script type="text/javascript">
	function idFindBtn(){
		...
		//console.log(name, email);
		 ...
		 $.ajax({
				type:"GET",
				url:"idFind.do?user_email="+user_email+"&user_name="+user_name,
                                        ...
                                        <table class="regi_tool">
                                            <tr>
                                                <td colspan="2" style="text-align: center;">
                                                    <span>가입하실때 등록한 메일 주소로 알려드립니다.</span><br>
                                                    <span>가입할때 등록한 이름, 메일 주소를 입력해주세요.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>이름</th>
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center;"><input type="button" class="finalsub" value="발송" onclick="idFindBtn();"></td>
                                            </tr>
                                        </table>
                                    </form>
                                </div>
